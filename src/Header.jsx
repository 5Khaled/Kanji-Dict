...
function Header() {
  return (
    <header className="bg-transparent w-full flex justify-between items-center p-2">
      <Link to="/">
        <h1 className="text-white text-xl font-bold p-2 [text-shadow:_0_0_25px_rgb(255_255_255_/_100%)]">
          Kanji Dictionary
        </h1>
      </Link>
      {/* <ThemeSwitch /> */}
